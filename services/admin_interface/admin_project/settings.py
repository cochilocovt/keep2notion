...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-2vr!y4*t2#_&w3@^&yj&ib!aoxx_iz_)&3o_g+)s4yp=lblmep')
...
SYNC_SERVICE_URL = os.getenv('SYNC_SERVICE_URL', 'http://localhost:8002')
